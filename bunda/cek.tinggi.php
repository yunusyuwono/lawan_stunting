		...
		<div class="card-body p-1">
            ...
            <div class="form-group col-md-2">
                ...
                <div class="form-group col-md-3">
                    <label for="tinggi">Tinggi/Panjang Anak ( cm )</label>
...
function cekstatus(){
	...
	{
		$.ajax({
			url : "cek.tinggi.status.php",
			method : "POST",
			data : {bulan:bulan,anak:anak, usia: usia,tinggi:tinggi},
			success : function (data) {
				$('#status').html('<div class="alert alert-success" align="center">Tinggi atau Panjang Badan Anak anda dikategorikan sebagai <br><h3><b>' + data + '</b></h3></div>');
			}
		})
