...
<div class="container mt-2 p-0">
    <div class="card">
		...
		<div class="card-body p-1">
            <div class="row">
                <div class="col-6 p-3">
                    <a class="btn btn-lg btn-light w-100 border-dark p-1" data-bs-toggle="modal" data-bs-target="#mk" onclick="kirim('pengukuran')">
                        <img src="../icon/ukur.svg" class="img m-1" width="100px" height="100px">  <br>
                        Pengukuran
                    </a>
                </div>
                <div class="col-6 p-3">
                ...
                <div class="col-6 p-3">
                    <a class="btn btn-lg btn-light w-100 border-dark p-1" data-bs-toggle="modal" data-bs-target="#mk" onclick="kirim('materi')">
                        <img src="../icon/materi.svg" class="img m-1" width="100px" height="100px">  <br>
                        Materi
                    </a>
                </div>
            </div>
