...
{
    $skor=mysqli_fetch_array(mysqli_query($kon,"SELECT * from anakskor where idanak='$c[idanak]' order by idskor desc limit 1"));
    ?>
    <div class="list-group-item" onclick="window.location.href='profil.anak.detail?idanak=<?=$c['idanak'];?>'">
        <div class="row">
            <div class="col-11">
                <?=$c['nanak'];?>
            </div>
            ...
            <div class="col-4 p-1">
                ...
                Skor : <?=isset($skor['skor'])?$skor['skor']:'';?>
                </div>
            </div>
            <div class="col-8 p-1">
                <div class="btn btn-sm btn-dark w-100">
                <?=isset($skor['ket'])?$skor['ket']:'';?>
                </div>
            </div>
